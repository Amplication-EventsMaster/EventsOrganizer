...
@InputType()
class ResponseCreateNestedManyWithoutFeedbacksInput {
...
export { ResponseCreateNestedManyWithoutFeedbacksInput as ResponseCreateNestedManyWithoutFeedbacksInput };
