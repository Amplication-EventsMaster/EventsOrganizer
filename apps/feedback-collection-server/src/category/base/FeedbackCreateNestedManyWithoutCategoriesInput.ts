...
@InputType()
class FeedbackCreateNestedManyWithoutCategoriesInput {
...
export { FeedbackCreateNestedManyWithoutCategoriesInput as FeedbackCreateNestedManyWithoutCategoriesInput };
